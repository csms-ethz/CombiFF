...
class FamilyIdentifierHandler : public cnv::Handler {
 ...
 public:
  ...
  FamilyIdentifierHandler(std::ofstream& outputFile,
  ...
  void PrintOutput(const std::string& fmi,
                   const std::string& formula,
                   const std::string& smiles,
                   cnv::AdjacencyMatrix& A) ;
  void SearchFileForIsomer(const std::string& fmi, const std::string& familyFileName) ;
};
