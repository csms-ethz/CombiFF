...
typedef enum {range_unsaturations, range_bonds, range_single_bonds, range_double_bonds, range_triple_bonds, range_quadruple_bonds, range_rings, num_ranges} RangeRestriction;
