...
struct ElementProperties {
  ...
  ElementProperties(ElementSymbol symbol, Connectivity degree,
                    ElementNumber element_nr, ElementPriority priority,
                    double mass, bool hydrogen_in_smiles)
      : symbol(symbol),
        degree(degree),
...
static const std::unordered_map<ElementIdentifier, ElementProperties>
    element_property_map{
        ...
        {"F", ElementProperties({"F", 1, 9, 6, 18.998, false})},
        {"Cl", ElementProperties({"Cl", 1, 17, 7, 35.453, false})},
        {"Br", ElementProperties({"Br", 1, 35, 8, 79.904, false})},
