...
void PrintRestrictions(const std::string whitespaces,
  ...
  PrintRangedProperty(ranged_properties[range_unsaturations], whitespaces, "unsaturations:");
  PrintRangedProperty(ranged_properties[range_bonds], whitespaces, "total_bonds:");
  PrintRangedProperty(ranged_properties[range_single_bonds], whitespaces, "single_bonds:");
  PrintRangedProperty(ranged_properties[range_double_bonds], whitespaces, "double_bonds:");
  PrintRangedProperty(ranged_properties[range_triple_bonds], whitespaces, "triple_bonds:");
  PrintRangedProperty(ranged_properties[range_quadruple_bonds], whitespaces, "quadruple_bonds");
...
void PrintRangedProperty(const Range& r, const std::string whitespaces, const std::string name) {
