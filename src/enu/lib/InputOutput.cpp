...
void InputOutput::PrintInputOptions() {
  std::cout
      ...
      << "   - lines starting with a # are considered comments and are "
         "ignored\n\n"
      << "-output_directory: used to specify in which directory the "
         "enumeration "
         "files should be saved\n\n"
      << "-output: used to specify the file name of the enumeration file that "
         "is "
         "created for the formulas given by -formula\n\n"
      << "-formula: used to specify a molecular formula. The following formats "
         "can be used to specify the numbers and types of the atoms:\n"
